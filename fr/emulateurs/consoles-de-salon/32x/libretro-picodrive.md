...
## ![](/migration-images/emulateurs/consoles-de-salon/32x/gerald-g-parchment-background-or-border-5.svg) Licence

Ce core est sous licence [**non-commerciale**](https://github.com/libretro/picodrive/blob/master/COPYING)**.**

## ![](/migration-images/emulateurs/consoles-de-salon/32x/compatibility.png) Compatibilité

| RPI0/RPI1 | RPI2 | RPI3 | RPI4 | RPI-400 | ODROID XU4 | ODROID GO | PC x86 | PC x86\_64 |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |

## ![](/migration-images/emulateurs/consoles-de-salon/32x/cogwheel-145804_640.png)Fonctionnalités
...
## ![](/migration-images/emulateurs/consoles-de-salon/32x/tqfp32.svg)BIOS


>**Aucun bios n'est requis.**
{.is-success}

## \*\*\*\*![](/migration-images/emulateurs/consoles-de-salon/32x/rom-30098_640.png)**Roms**
...
## ![](/migration-images/emulateurs/consoles-de-salon/32x/hammer-28636_640.png)Configuration avancée de l'émulateur
...
## ![](/migration-images/emulateurs/consoles-de-salon/32x/kisspng-web-development-world-wide-web-computer-icons-webs-world-wide-web-icon-png-5ab05c24477216.4540070115215073642927.png)**Liens externes**
