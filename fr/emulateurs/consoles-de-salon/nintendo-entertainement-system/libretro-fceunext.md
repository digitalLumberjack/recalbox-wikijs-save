...
Ce core est sous licence [**GPLv2**](https://github.com/libretro/fceu-next/blob/master/fceumm-code/Copying).
...
* **Github utilisé** : [https://github.com/libretro/fceu-next/](https://github.com/libretro/fceu-next/)
* **Doc Libretro** : 
